#' The wetness value of a species in a specified database
#'
#' \code{species_w()} accepts a species and a database inventory and returns the
...
#' }
#'
#' @return The wetness value of the given species within the given database.
#'
#' @import dplyr
...
species_w <- function(species, database_id = NULL, database_inventory = NULL){
